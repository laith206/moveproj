         ...
         <div class="image">
             <div class="wrapper">
                 <a class="image play_trailer" data-id="jOAxchyLZ00" data-title="30 Coins: Official Trailer | HBO" href="/tv/89844" title="30 Coins">
                     ...
                     <img loading="lazy" class="backdrop" src="//image.tmdb.org/t/p/w355_and_h200_multi_faces/${allTvtop[i].backdrop_path}" 
                         alt="">
        ...
        <div class="image">
            <div class="wrapper">
                <a class="image" href="/movie/577922" title="Tenet">
                    ...
                    <img loading="lazy" class="poster" src="//image.tmdb.org/t/p/w220_and_h330_face/${allTrending[i].poster_path}"
                        alt="">
...
function showsearch(allmovejson) {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        <div class="image">
            <div class="wrapper">
                <a class="image" href="/tv/82856" title="The Mandalorian">
                    <img loading="lazy" class="poster" src="https://image.tmdb.org/t/p/w300${allmovejson[i].poster_path || allmovejson[i].backdrop_path}" 
                        alt="">
                </a>
            </div>
            <div class="options" data-id="82856" data-object-id="5bb6f5970e0a26338e01fb97" data-media-type="tv" data-role="tooltip">
